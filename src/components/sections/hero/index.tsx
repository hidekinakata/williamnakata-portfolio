...
export default async function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-svh w-full flex-col justify-center overflow-hidden pt-20 pb-10 sm:pt-24 sm:pb-16 lg:pt-28 lg:pb-28 xl:min-h-[108svh] xl:pt-32 xl:pb-32 3xl:min-h-[110svh] 3xl:pt-36 3xl:pb-36">
      ...
      <div className="absolute top-24 left-8 lg:left-14 3xl:left-20 hidden lg:flex flex-col gap-0.5 mt-6">
        <span className="font-mono text-3xs 3xl:text-2xs leading-3 tracking-[0.14em] uppercase text-royal-500/40">
          {t("coordinates")}
        </span>
      ...
      <div className="absolute bottom-24 left-8 lg:left-14 3xl:left-20 hidden lg:flex items-center gap-2 rounded-full bg-royal-500/8 border border-royal-500/28 py-1.5 px-4">
        <span className="relative flex h-1.5 w-1.5">
          ...
          <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-royal-500" />
        </span>
      ...
      <div className="absolute bottom-10 right-8 lg:right-14 3xl:right-20 hidden lg:flex items-center gap-2">
        <span className="font-mono text-2xs leading-3 tracking-[0.14em] uppercase text-neutral-600">
          Scroll
        </span>
        <span className="block w-10 h-px bg-royal-500/35" />
      </div>

      {/* Rotated label */}
      <div className="absolute right-8 lg:right-14 3xl:right-20 top-1/2 -translate-y-1/2 hidden 2xl:flex">
        <span className="font-mono text-2xs leading-3 tracking-[0.14em] uppercase text-royal-500/18 -rotate-90 origin-center whitespace-nowrap">
